...
export const LoginModal = ({ closeModalhandler }) => {
  ...
  const el = document.getElementById('login') || document.body.appendChild(NodeEl);
  return ReactDOM.createPortal(<Login closeModalhandler={closeModalhandler}></Login>, el);
};
